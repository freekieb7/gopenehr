...
// func Unmarshal(v any, source any) error {
// 	rv := reflect.ValueOf(v)

// 	if rv.IsNil() {
// 		return fmt.Errorf("openehr: Unmarshal(nil)")
// 	}

// 	if rv.Kind() != reflect.Pointer {
// 		return fmt.Errorf("openehr: Unmarshal(non-pointer %s)", rv.Type().String())
// 	}

// 	return unmarshal(rv, source)
// }

// func unmarshal(rv reflect.Value, source any) error {
// 	switch rv.Kind() {
// 	case reflect.Bool:
// 		{
// 			b, ok := source.(bool)
// 			if !ok {
// 				return errors.New("is not bool")
// 			}
// 			rv.SetBool(b)
// 		}
// 	case reflect.String:
...
// 		{
// 			reflect.P
// 			return Unmarshal(rv.Elem(), source)
// 		}
// 	case reflect.Slice:
// 		{
// 			_, ok := source.([]any)
// 			if !ok {
// 				return errors.New("is not map")
// 			}
...
// 				//     var v any
// 				//     v = &v
// 				if rv.Elem().Kind() == reflect.Interface && rv.Elem().Elem().Equal(rv) {
// 					rv = rv.Elem()
// 					break
// 				}
...
// 			for elementName, elementValue := range m {
// 				for i := range rt.NumField() {
// 					field := rt.Field(i)
// 					tag := field.Tag.Get("openehr")
// 					if tag == "" {
// 						return fmt.Errorf("missing openehr tag for field %s in struct %s", field.Type, rv.Type().Name())
// 					}
...
// 					if err := unmarshal(rv.Field(i), elementValue); err != nil {
// 						return err
// 					}
// 					break
// 				}
...
// 	default:
// 		{
// 			return fmt.Errorf("unexpected kind %s for %s", rv.Kind(), rv.Type())
// 		}
// 	}
...
// 	STATE_STRING_UTF8_SECOND_TO_LAST_BYTE_GUARD_AGAINST_OVERLONG       // State C
// 	STATE_STRING_UTF8_SECOND_TO_LAST_BYTE_GUARD_AGAINST_SURROGATE_HALF // State D
...
// func (scanner *Scanner) Unmarshal(value any) error {
// 	rv := reflect.ValueOf(value)
// 	err := unmarshal(rv, &scanner)
...
// 		return errors.New("assert end of document failed")
// 	}

// 	return nil
// }

// func (scanner *Scanner) unmarshal(value reflect.Value) error {
// 	switch value.Kind() {
// 	case reflect.Bool:
// 		{
// 			token, err := scanner.Next()
...
// 				value.SetBool(false)
// 			default:
// 				return fmt.Errorf("unknown type %s", value.Kind())
// 			}
// 		}
// 	default:
// 		{
