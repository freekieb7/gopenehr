...
//
//  ======================= Lexical rules ========================
//  The followings are copies of https://github.com/openEHR/adl-aql/blob/master/src/main/aql/adl2/base_lexer.g4 rules, with some modifications required by AQL
//
...
fragment ISO8601_DATE_TIME
    ...
    | YEAR '-' MONTH '-' DAY ('T' HOUR ':' MINUTE ':' SECOND ('.' MICROSECOND)? TIMEZONE?)?
    ;
fragment MICROSECOND: [0-9][0-9][0-9] ([0-9][0-9][0-9])?;
