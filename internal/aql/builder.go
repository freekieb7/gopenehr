...
var (
	EHR          = reflect.TypeFor[model.EHR]()
	CONTRIBUTION = reflect.TypeFor[model.CONTRIBUTION]()
	EHR_STATUS   = reflect.TypeFor[model.EHR_STATUS]()
	EHR_ACCESS   = reflect.TypeFor[model.EHR_ACCESS]()
	COMPOSITION  = reflect.TypeFor[model.COMPOSITION]()
	FOLDER       = reflect.TypeFor[model.FOLDER]()

	OBSERVATION = reflect.TypeFor[model.OBSERVATION]()
	EVALUATION  = reflect.TypeFor[model.EVALUATION]()
	INSTRUCTION = reflect.TypeFor[model.INSTRUCTION]()
	ACTION      = reflect.TypeFor[model.ACTION]()

	CONTENT_ITEM   = reflect.TypeFor[model.CONTENT_ITEM]()
	ENTRY          = reflect.TypeFor[model.ENTRY]()
	CARE_ENTRY     = reflect.TypeFor[model.CARE_ENTRY]()
	EVENT          = reflect.TypeFor[model.EVENT[any]]()
	ITEM_STRUCTURE = reflect.TypeFor[model.ITEM_STRUCTURE]()
	ITEM           = reflect.TypeFor[model.ITEM]()
	EVENT_CONTEXT  = reflect.TypeFor[model.EVENT_CONTEXT]()
	SECTION        = reflect.TypeFor[model.SECTION]()
	GENERIC_ENTRY  = reflect.TypeFor[model.GENERIC_ENTRY]()
	ADMIN_ENTRY    = reflect.TypeFor[model.ADMIN_ENTRY]()
	ACTIVITY       = reflect.TypeFor[model.ACTIVITY]()
	HISTORY        = reflect.TypeFor[model.HISTORY[any]]()
	POINT_EVENT    = reflect.TypeFor[model.POINT_EVENT[any]]()
	INTERVAL_EVENT = reflect.TypeFor[model.INTERVAL_EVENT[any]]()
	FEEDER_AUDIT   = reflect.TypeFor[model.FEEDER_AUDIT]()
	ITEM_LIST      = reflect.TypeFor[model.ITEM_LIST]()
	ITEM_SINGLE    = reflect.TypeFor[model.ITEM_SINGLE]()
	ITEM_TABLE     = reflect.TypeFor[model.ITEM_TABLE]()
	ITEM_TREE      = reflect.TypeFor[model.ITEM_TREE]()
	CLUSTER        = reflect.TypeFor[model.CLUSTER]()
	ELEMENT        = reflect.TypeFor[model.ELEMENT]()

	ROLE         = reflect.TypeFor[model.ROLE]()
	PERSON       = reflect.TypeFor[model.PERSON]()
	AGENT        = reflect.TypeFor[model.AGENT]()
	GROUP        = reflect.TypeFor[model.GROUP]()
	ORGANISATION = reflect.TypeFor[model.ORGANISATION]()

	PARTY_RELATIONSHIP = reflect.TypeFor[model.PARTY_RELATIONSHIP]()
