...
type DV_TIME struct {
	...
	NormalRange          utils.Optional[DV_INTERVAL[*DV_TIME]]       `json:"normal_range,omitzero"`
	OtherReferenceRanges utils.Optional[[]REFERENCE_RANGE[*DV_TIME]] `json:"other_reference_ranges,omitzero"`
...
func (d *DV_TIME) Validate(path string) util.ValidateError {
