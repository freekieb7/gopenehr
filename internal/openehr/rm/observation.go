...
const OBSERVATION_TYPE string = "OBSERVATION"
...
func (o *OBSERVATION) SetModelName() {
	o.Type_ = utils.Some(OBSERVATION_TYPE)
	o.Name.SetModelName()
	if o.UID.E {
...
func (o *OBSERVATION) Validate(path string) util.ValidateError {
	...
	// Validate _type
	if o.Type_.E && o.Type_.V != OBSERVATION_TYPE {
		attrPath = path + "._type"
		validateErr.Errs = append(validateErr.Errs, util.ValidationError{
			Model:          OBSERVATION_TYPE,
			Path:           attrPath,
			Message:        "_type must be " + OBSERVATION_TYPE,
			Recommendation: "Set _type to " + OBSERVATION_TYPE,
		})
	}
