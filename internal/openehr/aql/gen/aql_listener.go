...
type AQLListener interface {
	...
	// EnterClassExprOperand is called when entering the classExprOperand production.
	EnterClassExprOperand(c *ClassExprOperandContext)
	...
	// ExitClassExprOperand is called when exiting the classExprOperand production.
	ExitClassExprOperand(c *ClassExprOperandContext)
