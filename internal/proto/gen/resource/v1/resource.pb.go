...
import (
	v1 "github.com/freekieb7/gopenehr/internal/proto/gen/common/v1"
...
const file_resource_v1_resource_proto_rawDesc = "" +
	"\n" +
	"\x1aresource/v1/resource.proto\x12\vresource.v1\x1a\x16common/v1/common.proto\"\xb0\x01\n" +
	"\bResource\x123\n" +
	"\n" +
	"attributes\x18\x01 \x03(\v2\x13.common.v1.KeyValueR\n" +
	"attributes\x128\n" +
	"\x18dropped_attributes_count\x18\x02 \x01(\rR\x16droppedAttributesCount\x125\n" +
	"\ventity_refs\x18\x03 \x03(\v2\x14.common.v1.EntityRefR\n" +
	"entityRefsB\xab\x01\n" +
	"\x0fcom.resource.v1B\rResourceProtoP\x01Z<github.com/freekieb7/gopenehr/internal/proto/gen/resource/v1\xa2\x02\x03RXX\xaa\x02\vResource.V1\xca\x02\vResource\\V1\xe2\x02\x17Resource\\V1\\GPBMetadata\xea\x02\fResource::V1b\x06proto3"
...
var file_resource_v1_resource_proto_goTypes = []any{
	...
	(*v1.EntityRef)(nil), // 2: common.v1.EntityRef
}
var file_resource_v1_resource_proto_depIdxs = []int32{
	1, // 0: resource.v1.Resource.attributes:type_name -> common.v1.KeyValue
	2, // 1: resource.v1.Resource.entity_refs:type_name -> common.v1.EntityRef
