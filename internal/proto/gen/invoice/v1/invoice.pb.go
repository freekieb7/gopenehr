...
const file_invoice_v1_invoice_proto_rawDesc = "" +
	...
	"\finvoice_date\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\vinvoiceDate\x123\n" +
	"\n" +
	"line_items\x18\x04 \x03(\v2\x14.invoice.v1.LineItemR\tlineItems\"\x86\x01\n" +
	"\bLineItem\x12 \n" +
	"\fline_item_id\x18\x01 \x01(\tR\n" +
	"lineItemId\x12\x1d\n" +
	"\n" +
